...
Optuna artifacts and mid-trial resume live under `data/training/<study_name>/spower/` (independent of Voltage). See [`pair_aware_training.md`](pair_aware_training.md#mid-trial-resume).
