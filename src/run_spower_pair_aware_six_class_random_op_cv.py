...
TRAIN_SCRIPT = SRC_DIR / "training_spower_pair_aware_six_class.py"
PLOT_SCRIPT = SRC_DIR / "plot_spower_pair_aware_six_class.py"
NUM_CLASSES = 6
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Random whole-OP CV for pair-aware learned six-class Spower GNN"
    )
