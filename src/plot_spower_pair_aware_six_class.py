...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Plot pair-aware six-class Spower GNN results")
...
def main() -> None:
    ...
    history_path = run_dir / "training" / "spower_pair_aware_six_class_gnn" / "history.csv"
